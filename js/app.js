(() => {
    ...
    function initSliders() {
        if (document.querySelector(".product-main-slider__slider")) new core(".product-main-slider__slider", {
            ...
            effect: "coverflow",
            pagination: {
                el: ".product-main-slider__controll .swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const lineCircles = document.querySelectorAll(".mainblock__line .circle");
        const ellipseCircles = document.querySelectorAll(".mainblock__ellipse .circle");
        function resetLineCircles() {
        ...
        function resetEllipseCircles() {
            ellipseCircles.forEach((circle => {
                circle.classList.remove("active");
                circle.setAttribute("r", circle.dataset.initialR);
            }));
        }
        lineCircles.forEach(((circle, index) => {}));
        ellipseCircles.forEach(((circle, index) => {
            circle.dataset.initialR = circle.getAttribute("r");
            circle.addEventListener("mouseover", (function() {
                if (!circle.classList.contains("active")) circle.setAttribute("r", "10.5");
            }));
            circle.addEventListener("mouseout", (function() {
                if (!circle.classList.contains("active")) circle.setAttribute("r", circle.dataset.initialR);
            }));
            circle.addEventListener("click", (function() {
                ...
                const imagePath = circle.dataset.image;
                const itemImage = document.querySelector(".item360__image img");
                itemImage.setAttribute("src", imagePath);
            }));
        }));
        function autoSwitchBullets() {
            const activeCircleLine = document.querySelector(".mainblock__line .circle.active");
            const activeCircleEllipse = document.querySelector(".mainblock__ellipse .circle.active");
            const nextCircleLine = activeCircleLine ? activeCircleLine.nextElementSibling : document.querySelector(".mainblock__line .circle");
            const nextCircleEllipse = activeCircleEllipse ? activeCircleEllipse.nextElementSibling : document.querySelector(".mainblock__ellipse .circle");
            lineCircles.forEach((circle => {
                circle.classList.remove("active", "auto-switch");
                circle.style.width = "10px";
                circle.style.height = "10px";
                circle.style.borderWidth = "2px";
            }));
            ...
            if (nextCircleLine) {
                nextCircleLine.classList.add("active", "auto-switch");
                nextCircleLine.style.width = "15px";
                nextCircleLine.style.height = "15px";
                nextCircleLine.style.borderWidth = "4px";
            }
            if (nextCircleEllipse) {
                nextCircleEllipse.classList.add("active", "auto-switch");
                nextCircleEllipse.setAttribute("r", "10.5");
            }
            const imagePathLine = nextCircleLine ? nextCircleLine.dataset.image : "";
            const imagePathEllipse = nextCircleEllipse ? nextCircleEllipse.dataset.image : "";
            const itemImage = document.querySelector(".item360__image img");
            itemImage.setAttribute("src", imagePathLine || imagePathEllipse);
        }
        if (window.innerWidth < 900) setInterval(autoSwitchBullets, 3e3);
    }));
    window["FLS"] = true;
    isWebp();
    addTouchClass();
